...
from handlers.account.add_account import add_account, process_phone_number, process_auth_code, process_password
...
def register_account_handlers(dp: Dispatcher):
    ...
    dp.message.register(process_auth_code, AddAccountStates.waiting_for_code)
    dp.message.register(process_password, AddAccountStates.waiting_for_password)
